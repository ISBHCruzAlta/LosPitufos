...
while not hecho:
    ...
    pygame.draw.rect(pantalla,ROJO,[30,30,250,100],2 )
    pygame.draw.rect(pantalla, AZUL, [150, 20, 60, 20])
    pygame.draw.ellipse(pantalla,ROJO,[60,30,250,100],3)
    pygame.draw.polygon(pantalla,VIOLETA,[[100,100],[0,200],[200,200]],5)
